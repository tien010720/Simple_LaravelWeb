<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-map-marker"></i> CÔNG TY TNHH LÊ VƯƠNG</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 091 777 42 34</a></li>
						<li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					...
					@else
						<li><a href="{{route('signin')}}"><i class="fa fa-user-plus"></i>Đăng kí</a></li>
			...
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo">
						<img src="source/assets/dest/images/log0.png" width="70px" alt=""></a>
				</div>
		...
		<div class="header-bottom" style="background-color: #454545;">
			<div class="container">
