...
<div class="container">
	<div id="content">
		...
		<form action="{{route('dathang')}}" method="post" class="beta-form-checkout">
			...
			<h1> <center>
				<font face="iCiel Cadena" color="#FF9933"><div class="row">
				@if(Session::has('thongbao')){{Session::get('thongbao')}}
			    @endif</div></h1> </font> </center> </BR>
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-block">
						...
						<input type="text" name="name" placeholder="Điền Họ tên..." required>
					</div>
					<div class="form-block">
					...
					<div class="your-order">
						...
						<div class="your-order-body" style="padding: 0px 10px">
							...
							<div class="your-order-item" >
								...
								@if(Session::has('cart')){{number_format($totalPrice)}}@else 0 @endif đồng</h5></div>
								<div class="clearfix"></div>
							</div>
						</div>
