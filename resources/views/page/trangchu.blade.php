				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							<h4><span style="font-family: iCiel Cadena">Sản Phẩm Mới</span></h4>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}"><img src="source/image/product/{{
												$new->image}}" alt=""  height="210px" width="270px" ></a>
										</div>
						 ...
						 <h7>
							...
							<span class="fa fa-star checked"></span>
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('themgiohang',$new->id)}}"><i class="fa fa-shopping-cart"></i>
										</a>
						...
						<div class="beta-products-list">
							<h4><span style="font-family: iCiel Cadena">Sản phẩm khuyến mãi</span></h4>
							 <div class="beta-products-details">
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" height="210px" width="270px"></a>
										</div>
										<div class="single-item-body">
